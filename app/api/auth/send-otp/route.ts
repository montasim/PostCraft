...
export async function POST(request: NextRequest) {
  try {
    ...
    await sendEmail({
      ...
      text: `Your PostCraftt verification code is: ${code}\n\nThis code expires in ${OTP.EXPIRY_MINUTES} minutes.\n\nNever share this code with anyone.PostCraftft will never ask for your code.`,
      html: buildEmailLayout(
        `
        <h1 style="font-size:22px;font-weight:700;color:${EMAIL_BRAND.LIGHT.foreground};margin:0 0 4px;">Verify it's you</h1>
        <p style="font-size:15px;color:${EMAIL_BRAND.LIGHT.foreground};line-height:1.6;margin:0 0 24px;">
          Enter this code to complete your action. It expires in ${OTP.EXPIRY_MINUTES} minutes.
        </p>

        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
          <tr>
            <td align="center" style="padding:20px 0;background-color:${EMAIL_BRAND.LIGHT.surface};border-radius:12px;">
              <span style="font-size:36px;font-weight:700;letter-spacing:6px;color:${EMAIL_BRAND.LIGHT.primary};font-family:monospace;">
                ${code}
              </span>
            </td>
          </tr>
          ...
          <tr>
            <td align="center" style="padding:12px;background-color:${EMAIL_BRAND.LIGHT.primaryLight};border-radius:8px;">
              <p style="font-size:13px;color:${EMAIL_BRAND.LIGHT.mutedForeground};line-height:1.5;margin:0;">
                Never share this code with anyone. PostCraftt will never ask for your verification code.
              </p>
            </td>
          </tr>
        </table>
