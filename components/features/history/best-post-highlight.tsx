...
function BestPostHighlight({ entry, copied, onCopy }: BestPostHighlightProps) {
  ...
  return (
    ...
    >
      <Badge className="absolute -top-3 left-6 grid-flow-col items-center gap-1 rounded-full bg-linear-to-r from-primary to-accent px-2.5 py-1 text-[10px] font-bold uppercase leading-none tracking-wider text-primary-foreground shadow">
