...
Cohesion: 0.13
Nodes (16): useMediaQuery(), ActivityHeatmapProps, BestPostHighlight(), BestPostHighlightProps, LibraryContent(), LibraryDetail(), LibraryFilters(), LibraryGrid() (+8 more)
...
Cohesion: 0.09
Nodes (13): EmptyState(), EmptyStateProps, HighDemandCard(), HighDemandCardProps, MotivationTip(), TIPS, SelectOption, NavGroup() (+5 more)
...
Cohesion: 0.15
Nodes (11): LibraryEmpty(), LibraryEmptyProps, LibraryFiltersProps, LibraryGridProps, QuotaAlert(), selectQuotaExceeded(), metadata, TrendingHeader() (+3 more)
...
Cohesion: 0.33
Nodes (4): API, SCORE_RANGES, DEFAULT_FILTERS, LibraryStats
